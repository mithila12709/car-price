...
#when we call Dataingestion class,those 3 paths are saved in this class variable(self.ingestion)
...
if __name__=="__main__":
    ...
    # now we are calling all the function from transformation.py
